...
registerLicense(
  "Ngo9BigBOggjHTQxAR8/V1NHaF5cXmVCf1JpR2JGfV5yd0VEal1UTnNdUj0eQnxTdEZiWX1ccXBUQ2VfVU1+XA=="
);
...
//     new DataManager(exp)
//       .executeQuery(
//         new Query().where(predicate.and("TransactionType", "equal", "Income"))
//       )
//       .then((e) => {
...
//         tempIncomeDS[cur.DateTime.getMonth()].Amount =
//           parseInt(curDateTime.Amount, 0) + parseInt(cur.Amount, 0);
//       } else {
//         tempIncomeDS[cur.DateTime.getMonth()] = cur;
//         tempIncomeDS[cur.DateTime.getMonth()].DateTime = new Date(
//           new Date(
//             tempIncomeDS[cur.DateTime.getMonth()].DateTime.setHours(0, 0, 0, 0)
//           ).setDate(1)
//         );
//       }
//     }
...
//         tempExpenseDS[cur.DateTime.getMonth()].Amount =
//           parseInt(curDateTime.Amount, 0) + parseInt(cur.Amount, 0);
//       } else {
//         tempExpenseDS[cur.DateTime.getMonth()] = cur;
//         tempExpenseDS[cur.DateTime.getMonth()].DateTime = new Date(
//           new Date(
//             tempExpenseDS[cur.DateTime.getMonth()].DateTime.setHours(0, 0, 0, 0)
//           ).setDate(1)
//         );
//       }
//     }
...
//     for (
//       let data = 0;
//       data < Object.keys(colIncomeDS.concat(colExpenseDS)).length;
//       data++
//     ) {
//       result.push(obj[data]);
//     }
...
//         lineD[cur.DateTime.getMonth()].Amount = Math.abs(
//           parseInt(curDateTime.Amount, 0) - parseInt(cur.Amount, 0)
//         );
//       } else {
...
//         start.valueOf() <= item.DateTime.valueOf() &&
...
//             <ChartComponent
//               id="Linecharts"
//               chartArea={lchartArea}
//               ref={(lchart) => (lineChart = lchart)}
//               primaryXAxis={lprimaryXAxis}
//               primaryYAxis={lprimaryYAxis}
//               margin={lmargin}

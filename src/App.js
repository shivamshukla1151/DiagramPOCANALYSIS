...
function App() {
  let diagramRef = React.useRef(null);
  let shape = { type: "HTML" };
  let constraints =
    NodeConstraints.Default & ~NodeConstraints.Resize & ~NodeConstraints.Rotate;
  let iamge =
    "https://img.freepik.com/free-vector/open-book-isolated_1284-43075.jpg?w=1480&t=st=1697972001~exp=1697972601~hmac=c70f4b9751f4093eeae900e902b0e6b1dfde35e726cbe257cf27722330d68cb9";
  let nodes = [
    {
      id: "node",
      ...
      width: 500,
      height: 500,
      shape: { type: "HTML", content: lineChart },
    ...
    },
    {
      ...
      width: 450,
      height: 450,
      shape: { type: "HTML", content: customHtml },
      constraints: constraints,
    },
  ];
    ...
    let basicShapes = [
      ...
      },
      {
        ...
        shape: {
          type: "HTML",
          content:
            '<div><div style="height:50%;width:100%;"><input type="checkbox" value="Yes" style="width:25%">Yes</input></div>' +
      ...
      >
        <div>
          <DropDownButtonComponent
            ...
            id="element"
            iconCss="e-icon more-vertical-1"
            items={items}
          ></DropDownButtonComponent>
        </div>
        <img
  ...
  function htmmlShape() {
    return (
      <div style={{ backgroundColor: "green", height: "50px", width: "100px" }}>
        Something with html div
      </div>
    );
  }
  ...
  function diagramTemplate(props) {
    console.log("This is diagram Template", props);

    // if (props.id.includes("Dropdown")) {
    console.log("Inside If");

    return <div>{customHtml()}</div>;
    // }
  }

  function getDragEle(obj) {
    console.log("This is Object:", obj);
    obj.element.properties.shape.type = "HTML";
    // obj.element.properties.shape.content = customHtml();
    // obj.properties.constraints = constraints;

    obj.element.shape.changedProperties.type = "HTML";

    obj.element.properties.type = "HTML";

    // obj.properties.type = "HTML";

    // obj.shape.changedProperties.content = getHTML(obj.oldProperties.id);

    // obj.element.shape.content = customHtml();

    // obj.shape.type = "HTML";

    // obj.shape.properties.content = getHTML(obj.oldProperties.id, obj.properties.id);

    // obj.properties.content = getHTML(obj.oldProperties.id);
    console.log("This is diagram ref after drag:", diagramRef);
  }
  ...
  console.log("diagramRef:", diagramRef);
  return (
    <div
      className="App"
      style={{
